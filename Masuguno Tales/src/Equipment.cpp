...
Equipment::Equipment(int _id, const char* spritePath, const char* _equipmentTag, std::string _equipmentName, int _maxHealth, int _maxMana, int _damage, int _defense, int _attackSpeed)
