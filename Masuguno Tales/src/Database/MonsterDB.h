...
struct MonsterType{
    ...
    MonsterType(int _monster_id, int _width, int _height, std::string _monsterName, std::string _monsterSprite, float _damage, float _health, float _attackSpeed,
                ...
                int _item_reward_id, float _item_drop_percent, int _equipment_reward_id, float _equipment_drop_percent)
    ...
    item_drop_percent(_item_drop_percent), equipment_reward_id(_equipment_reward_id), equipment_drop_percent(_equipment_drop_percent)
    {}
};
